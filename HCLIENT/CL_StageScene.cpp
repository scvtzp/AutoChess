...
CL_StageScene* CL_StageScene::Inst;
HBoneAnimationCom* CL_StageScene::AniCom = nullptr;

Game_Ptr<HCAM> CamPtr;

CL_StageScene::CL_StageScene()
{
	Inst = this;
}
CL_StageScene::~CL_StageScene()
...
void CL_StageScene::SceneChangeStart()
{
...
void CL_StageScene::Init()
{

}

void CL_StageScene::Update()
{
...
void CL_StageScene::LoadAni(Game_String _Name)
{
	////유닛
	{
...
void CL_StageScene::Load_Functions()
{
	{
		HGAMEDIRECTORY Dic;
...
void CL_StageScene::PlayerUpdate()
{
